      ...
      <div className="container max-w-5xl mx-auto text-center">
        ...
        <div className="flex flex-wrap gap-6 justify-center">
          {filteredSkills.map((skill, key) => (
            <div
              key={key}
              className="w-32 p-4 bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md flex flex-col items-center gap-2 hover:scale-105 hover:shadow-2xl transition-transform duration-300"
            >
              {skill.logo}
